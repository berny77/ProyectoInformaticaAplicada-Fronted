                ...
                <div className="container">
                    ...
                    <div className="social-media order-lg-last">
                        <p className="mb-0 d-flex">
                            ...
                            <a data-action="Log out" className="d-flex align-items-center justify-content-center a-icon tooltiplg" onClick={()=> navigate('/login')}><span className="fa fa-power-off"><i className="sr-only">Logout</i></span></a>
                        </p>
                    </div>
                    ...
                    <div className="navbar-collapse collapse" id="ftco-nav">
                        <ul className="navbar-nav ml-auto mr-md-3">
                            ...
                            <li className="nav-item"><a href="#" className="nav-link" onClick={() => navigate('/configuration')}>Configuracion</a></li>
                            <li className="nav-item"><a href="#" className="nav-link" onClick={() => navigate('/activity')}>Actividad</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
